...
using System.Diagnostics;
{
    ...
    //}
    //Console.WriteLine($"序列化 Count = {count}");
    //string strJson = "";
    //List<Task> tasks = new() {
    //    Task.Run(() => {
    //        Stopwatch sw = new();
    //        sw.Start();
    //        strJson = System.Text.Json.JsonSerializer.Serialize(list);
    //        sw.Stop();
    //        Console.WriteLine($"System.Text.Json.JsonSerializer.Serialize：{sw.ElapsedMilliseconds}ms");
    //    }),
    //    Task.Run(() => {
    //        Stopwatch sw = new();
    //        sw.Start();
    ...
    //        sw.Stop();
    //        Console.WriteLine($"Newtonsoft.Json.JsonConvert.SerializeObject：{sw.ElapsedMilliseconds}ms");
    //    })
    //};
    ...
    //        Stopwatch sw = new();
    //        sw.Start();
    //        System.Text.Json.JsonSerializer.Deserialize<List<Subject>>(strJson);
    //        sw.Stop();
    //        Console.WriteLine($"System.Text.Json.JsonSerializer.Deserialize：{sw.ElapsedMilliseconds}ms");
    //    }),
    //    Task.Run(() => {
    //        Stopwatch sw = new();
    //        sw.Start();
    //        Newtonsoft.Json.JsonConvert.DeserializeObject<List<Subject>>(strJson);
    //        sw.Stop();
    //        Console.WriteLine($"Newtonsoft.Json.JsonConvert.DeserializeObject：{sw.ElapsedMilliseconds}ms");
    //    })
    //};
